...
public class FrmExer2 extends javax.swing.JFrame {
    ...
    private void BntFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BntFecharActionPerformed
        if(JOptionPane.showConfirmDialog(null,"Você tem certeza que deseja fechar o Exercício?",
          "Saida",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
           JOptionPane.showMessageDialog(null, "Boa sorte sem sua nota!",
                   "#FUI",JOptionPane.ERROR_MESSAGE);
        this.dispose();
        }else{
           JOptionPane.showMessageDialog(null,"Você escolheu ficar!"
            ,"Continuar o execicio", JOptionPane.WARNING_MESSAGE);
       }
    ...
    private void BtnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCalcularActionPerformed
     ...
     JOptionPane.showMessageDialog(null, "ola "+sexo+nome+"\n"+"O peso ideal para sua altura é:"+resultado);
